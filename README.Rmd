...
rarly be more than 7 outliers when using `wodds`.
...
Though not neccesary it is possible to include tail area if additional communication or
teaching is needed. It is assumed that the `wodd` should be explainatory enough
